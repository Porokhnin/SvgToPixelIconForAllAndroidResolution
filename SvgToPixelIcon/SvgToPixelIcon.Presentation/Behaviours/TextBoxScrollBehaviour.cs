...
namespace SvgToPixelIcon.Presentation.Behaviours
{
    public class TextBoxScrollBehaviour
    {
        ...
        public static readonly DependencyProperty ScrollOnTextChangedProperty =
            DependencyProperty.RegisterAttached("ScrollOnTextChanged", typeof(bool), typeof(TextBoxScrollBehaviour), new UIPropertyMetadata(false, OnScrollOnTextChanged));
